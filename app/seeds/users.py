...
def seed_users():
    demo = User(
        first_name='Demo', last_name= 'User', username='Demo', email='demo@aa.io', password='password', profile_picture='https://upload.wikimedia.org/wikipedia/en/c/cc/Wojak_cropped.jpg')
    marnie = User(
